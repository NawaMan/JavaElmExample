...
var $author$project$Main$LoadPerson = $elm$core$Basics$identity;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ar: false, at: r.at, ax: r.ax, Q: r.Q, aD: r.aD, aO: r.aO, al: r.al, aR: r.aR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{at: $elm$http$Http$emptyBody, ax: r.ax, Q: _List_Nil, aD: 'GET', aO: $elm$core$Maybe$Nothing, al: $elm$core$Maybe$Nothing, aR: r.aR});
};
var $author$project$Person$Person = F2(
	function (firstName, lastName) {
		return {az: firstName, U: lastName};
	});
...
var $author$project$Main$loadPersons = $elm$http$Http$get(
	{
		ax: A2($elm$http$Http$expectJson, $elm$core$Basics$identity, $author$project$Person$personDecoder),
		aR: 'data/person.json'
	});
...
var $author$project$Main$viewPerson = function (model) {
	switch (model.$) {
		case 1:
			return A2(
				$elm$html$Html$div,
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('I got a person: '),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewPerson(model)
			]));
};
