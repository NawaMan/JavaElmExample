...
var $author$project$Main$LoadPersons = $elm$core$Basics$identity;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aq: false, as: r.as, aw: r.aw, Q: r.Q, aD: r.aD, aO: r.aO, ak: r.ak, aR: r.aR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{as: $elm$http$Http$emptyBody, aw: r.aw, Q: _List_Nil, aD: 'GET', aO: $elm$core$Maybe$Nothing, ak: $elm$core$Maybe$Nothing, aR: r.aR});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Person$Person = F2(
	function (firstName, lastName) {
		return {ay: firstName, aC: lastName};
	});
...
var $author$project$Main$loadPersons = $elm$http$Http$get(
	{
		aw: A2($elm$http$Http$expectJson, $elm$core$Basics$identity, $author$project$Person$personListDecoder),
		aR: 'data/persons.json'
	});
...
var $author$project$Main$viewPerson = function (person) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(person.ay),
				$elm$html$Html$text(' '),
				$elm$html$Html$text(person.aC)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewPersons(model)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aB: $author$project$Main$init, aN: $author$project$Main$subscriptions, aQ: $author$project$Main$update, aS: $author$project$Main$view});
