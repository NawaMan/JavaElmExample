...
var $author$project$Main$loadPersons = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$LoadPersons, $author$project$Person$personListDecoder),
		url: '/api/persons'
	});
...
var $author$project$Main$Adding = {$: 'Adding'};
var $author$project$Main$Data = F3(
	function (persons, person, mode) {
		return {mode: mode, person: person, persons: persons};
	});
...
var $author$project$Main$Listing = {$: 'Listing'};
var $author$project$Main$Viewing = {$: 'Viewing'};
var $author$project$Main$Reloaded = {$: 'Reloaded'};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, person.id))),
				_Utils_Tuple2(
				'firstName',
				$elm$json$Json$Encode$string(person.firstName)),
				_Utils_Tuple2(
				'lastName',
				$elm$json$Json$Encode$string(person.lastName)),
				_Utils_Tuple2(
				'nickName',
				A2(
					$elm$core$Maybe$withDefault,
...
var $author$project$Main$loadPerson = function (id) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$LoadPerson, $author$project$Person$personDecoder),
			url: '/api/persons/' + id
		});
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ViewPerson':
				...
				return _Utils_Tuple2(
					model,
					$author$project$Main$loadPerson(personId));
			case 'ChangePerson':
				var person = msg.a;
				return _Utils_Tuple2(
					model,
...
var $author$project$Main$EditLastName = function (a) {
	return {$: 'EditLastName', a: a};
};
var $author$project$Main$EditNickName = function (a) {
	return {$: 'EditNickName', a: a};
};
var $author$project$Main$ToViewing = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Edit Person')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ToViewing(data))
							]),
						_List_fromArray(
							[
...
var $author$project$Main$ToAdding = function (a) {
	return {$: 'ToAdding', a: a};
};
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Main$DeletePerson = function (a) {
	return {$: 'DeletePerson', a: a};
};
var $author$project$Main$ViewPerson = function (a) {
	return {$: 'ViewPerson', a: a};
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						person.firstName + (' ' + (person.lastName + $author$project$Main$wrap(person.nickName))))
					]))
			]));
};
var $author$project$Main$listPersons = function (data) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$ToAdding(data))
					]),
				_List_fromArray(
					[
...
var $author$project$Main$AddPerson = function (a) {
	return {$: 'AddPerson', a: a};
};
var $author$project$Main$ToListing = function (a) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ToListing(data))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Cancel')
...
var $author$project$Main$ToEditing = function (a) {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ToEditing(data))
							]),
						_List_fromArray(
							[
	...
	switch (model.$) {
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('I could not load person information. ')
					]));
		case 'Loading':
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Main$listPersons(data),
						function () {
						var _v1 = data.mode;
						switch (_v1.$) {
							case 'Listing':
							...
							case 'Adding':
								return $author$project$Main$newPerson(data);
							case 'Viewing':
								return $author$project$Main$viewPerson(data);
							default:
								return $author$project$Main$editPerson(data);
						}
					}()
					]));
	}
